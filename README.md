...
Current release is v1.2.0.  See [NEWS.md](NEWS.md).
A description paper is currently being prepared for release as a pre-orint and then potentially a peer-reviewed article. 
