...
Smith2014.scheme <- new("BiomeScheme",
                        ...
                        totals.needed = list(Tree = list(".Tree", "Tree"),
                                             Grass = list(".Grass", "Grass"),
                                             Boreal = list(".Boreal", "Boreal"),
                                             Temperate = list(".Temperate", "Temperate"),
                                             Tropical = list(".Tropical", "Tropical"),
                                             Total = list(".PFTs", "Total")),
                        max.needed = list(Tree = list(".Tree", "MaxTree")),
                        fractions.needed = list(GrassFraction = list("Grass", "Total", "GrassFraction"),
                                                BorealFractionOfTree = list("Boreal", "Tree", "BorealFractionOfTree"),
                                                TemperateFractionOfTree = list("Temperate", "Tree", "TemperateFractionOfTree"),
                                                TropicalFractionOfTree = list("Tropical", "Tree", "TropicalFractionOfTree"),
                                                TrBEFractionOfTree = list("TrBE", "Tree", "TrBEFractionOfTree"),
                                                TrBRFractionOfTree = list("TrBR", "Tree", "TrBRFractionOfTree"),
                                                TeBEFractionOfTree = list("TeBE", "Tree", "TeBEFractionOfTree"),
                                                TeBSFractionOfTree = list("TeBS", "Tree", "TeBSFractionOfTree")),
                        needGDD5 = FALSE,
...
Hickler2012.scheme <- new("BiomeScheme",
                          ...
                          totals.needed = list(Tree = list(".Tree", "Tree"),
                                               Grass = list(".Grass", "Grass"),
                                               Woody = list(c(".Tree", ".Grass"), "Woody"),
                                               Mediterranean = list(c(".Mediterranean"), "Mediterranean"),
                                               SupraMediterranean = list(c(".Supra-mediterranean"), "Supra-mediterranean")),
                          max.needed = list(Tree = list(".Tree", "MaxTree"),
                                            Grass = list(".PFTs", "MaxPFT")),
                          fractions.needed = list(GrassFraction = list("Grass", "Total", "GrassFraction"),
                                                  BorealFractionOfTree = list("Boreal", "Woody", "BorealFractionOfTree"),
                                                  TemperateFractionOfTree = list("Temperate", "Tree", "TemperateFractionOfTree"),
                                                  MediterraneanFractionOfTree = list("Mediterranean", "Tree", "MediterraneanFractionOfTree")),
                          needGDD5 = TRUE,
                          data.reference = "- (Bohn)",
...
MeditBiomes.scheme <- new("BiomeScheme",
                          ...
                          totals.needed = list(Tree = list(".Tree", "Tree"),
                                               Grass = list(".Grass", "Grass"),
                                               Woody = list(c(".Tree", ".Shrub"), "Woody")),
                          max.needed = list(Woody = list(c(".Tree", ".Shrub"), "MaxWoody")),
...
Megabiomes_dev.scheme <- new("BiomeScheme",
                             ...
                             max.needed = list(Tree = list(c(".Tree"), "MaxTree")),
                             fractions.needed = list(),
                             needGDD5 = TRUE,
                             data.reference = "Haxeltime and Prentice 1996",
                             published.reference = "-")
