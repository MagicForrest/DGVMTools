...
#' The idea is that you can use this function to pull a particular Layer from a list of Layer objects, or a particular run from a list of Source objects etc.
#' 
