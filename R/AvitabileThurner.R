...
getAvitabileThurner <- function(location = "/data/forrest/Biomass/", resolution = "HD") {
  
  
  #### NEW ORDER, CODE BELOW NOW REDUNDANT
  
  # read the standard dataset
  Avitabile.dt <- readData("Avitabile+Thurner",
                         location = location,
  ...
  Avitabile.dataset <- new("DataObject",
                           id = "Avitabile+Thurner",
                           name = "Avitabile et al 2015. and Thurner et al. 2014 Combined",
