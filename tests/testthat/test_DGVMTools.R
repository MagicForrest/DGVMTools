...
test_that("Selections and Cropping",{
  ...
  print(GUESS.Field.selected.gridcells.df.1)
  print(GUESS.Field.selected.gridcells.df.2)
  print(str(GUESS.Field.selected.gridcells.df.1@spatial.extent))
  print(str(GUESS.Field.selected.gridcells.df.2@spatial.extent))
